...
extension ContextExtensions on BuildContext {
  ...
  TextStyle? get subTitleFormTextStyle =>
      headerLine6Context!.copyWith(fontSize: 18);

  //NAVIGATION
  TextStyle? get navigationFormTextStyle =>
      headerLine3Context!.copyWith(fontWeight: FontWeight.w600);

  TextStyle? get labelNoNavigationFormTextStyle => headerLine2Context;

  TextStyle? get titleFormRoundCornerTextStyle => headerLine6Context!
      .copyWith(fontSize: 24, color: ColorConstant.whiteColor);

  TextStyle? get subTitleFormRoundCornerTextStyle => headerLine2Context!
      .copyWith(fontSize: 18, color: ColorConstant.whiteColor);

  //TEXT FIELD
  TextStyle? get defaultTextFieldTextStyle =>
      _bodyText1Context!.copyWith(fontSize: 14);

  //VERIFY MOBILE
  TextStyle? get mobileVerifyTextStyle =>
      headerLine4Context!.copyWith(fontSize: 16);
  ...
  TextStyle? get dateTimeItemViewTextStyle =>
      headerLine2Context!.copyWith(fontSize: 12);

  TextStyle? get detailTextStyle => headerLine6Context!.copyWith(fontSize: 14);

  TextStyle? get serialNumberTextStyle =>
      headerLine4Context!.copyWith(fontSize: 14);
